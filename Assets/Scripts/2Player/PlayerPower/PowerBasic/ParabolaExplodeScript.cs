...
public class ParabolaExplodeScript : ParabolaPowerScript
{
    [SerializeField]
    ...
    public override void SetPower(PlayerController _player, float _attack, float _magic, Vector2 _dir)
    {
        _magic = 0;
        _attack = 0;
        base.SetPower(_player, _attack, _magic, _dir);
    }

    ...
    public void CreateSkill()           // 스킬 오브젝트 생성
    {
        ...
        switch (type) {
            ...
            case ESkillType.RANGED_CC:
                skill.transform.localPosition = new Vector3(m_collider.transform.localPosition.x, m_collider.transform.localPosition.y + 1f, m_collider.transform.localPosition.z); // 코드가 깔끔하지 않음

...
public class PlayManager : MonoBehaviour
{
    ...
    public static void UpgradeStat(int[] _point) { ForceManager.UpgradeStat(_point); }                                                                  // 스탯 투자
    public static void UpgradeStat(EStatName _stat, int _amount) { ForceManager.UpgradeStat(_stat, _amount, true); }                                    // 보상 스탯
